...
public class EnumUserType implements UserType, ParameterizedType {
	...
	public void setParameterValues(Properties parameters) {
		...
		try {
			...
			throw new HibernateException("Classe enum " + enumClassName + " n�o encontrada", ex);
		}
	}
		...
		for (Enum e : constantes) {
			...
			if (obj == null) {
				...
				try {
					...
					logger.error("O enum " + obj.getClass() + " n�o extende a interface BaseEnum.", e1);
					throw new HibernateException("O enum " + obj.getClass() + " n�o extende a interface BaseEnum.", e1);
				}
			}
		}
